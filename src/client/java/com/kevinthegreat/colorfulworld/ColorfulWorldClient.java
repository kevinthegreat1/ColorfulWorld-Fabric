...
public class ColorfulWorldClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> Util.getColorFullAlphaFromStack(stack), ColorfulWorld.COLORFUL_CONCRETE_ITEM, ColorfulWorld.COLORFUL_CONCRETE_POWDER_ITEM, ColorfulWorld.COLORFUL_GLASS_ITEM, ColorfulWorld.COLORFUL_GLASS_PANE_ITEM);
    }
}
