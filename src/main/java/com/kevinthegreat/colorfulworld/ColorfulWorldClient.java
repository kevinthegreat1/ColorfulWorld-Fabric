...
public class ColorfulWorldClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ColorProviderRegistry.BLOCK.register((state, view, pos, tintIndex) -> view != null && pos != null ? (int) Objects.requireNonNullElseGet(((RenderAttachedBlockView) view).getBlockEntityRenderAttachment(pos), () -> Objects.requireNonNullElse(((RenderAttachedBlockView) view).getBlockEntityRenderAttachment(pos.down()), 0)) : 0, ColorfulWorld.COLORFUL_CONCRETE, ColorfulWorld.COLORFUL_CONCRETE_POWDER, ColorfulWorld.COLORFUL_GLASS, ColorfulWorld.COLORFUL_GLASS_PANE);
