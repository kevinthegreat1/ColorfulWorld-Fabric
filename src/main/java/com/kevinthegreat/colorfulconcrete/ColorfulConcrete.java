...
public class ColorfulConcrete implements ModInitializer {
    ...
    public static final Item COLORFUL_CONCRETE_ITEM = Registry.register(Registry.ITEM, Registry.BLOCK.getId(COLORFUL_CONCRETE), new BlockItem(COLORFUL_CONCRETE, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS)));
    public static final Item COLORFUL_CONCRETE_POWDER_ITEM = Registry.register(Registry.ITEM, Registry.BLOCK.getId(COLORFUL_CONCRETE_POWDER), new BlockItem(COLORFUL_CONCRETE_POWDER, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS)));
